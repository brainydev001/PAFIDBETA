    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Farmer Analytics</h1>
                    </div><!-- /.col -->
        ...
        {{-- data table --}}
            ...
            <div class="card">
                ...
                <div class="card-header">
                    Search And Sort Farmer Data
                </div>
                {{-- body --}}
                <div class="card-body">
                    
                    {{-- filter farmer --}}
                    <button class="btn btn-success m-2 text-white" type="button" data-toggle="modal" data-target="#filterFarmer">
                        <span>
                            Filter Farmer Data
                        </span>
                    ...
                    {{-- farmer modal --}}
                    @include('admin.analytics.inc.farmer_modal')
                </div>
                <!-- /.card-body -->
            </div>
    </div>
