    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Activity Analytics</h1>
                    </div><!-- /.col -->
        ...
        {{-- user datatable --}}
            ...
            <div class="card">
                ...
                {{-- heading --}}
                <div class="card-header">
                    Search And Sort Activity Data
                </div>
                {{-- body --}}
                <div class="card-body">

                    {{-- filter staff --}}
                    <button class="btn btn-warning m-2 text-dark" type="button" data-toggle="modal" data-target="#filterStaff">
                        <span> 
                    ...
                    {{-- activity modal --}}
                    @include('admin.analytics.inc.activity_modal')
