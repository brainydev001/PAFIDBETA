    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Expense Analytics</h1>
                    </div><!-- /.col -->
        ...
        <div class="card">
            ...
            <div class="card-header">
                Search And Sort Expense Data
            </div>
            {{-- body --}}
            <div class="card-body">

                {{-- filter farmer --}}
                <button class="btn btn-success m-2 text-white" type="button" data-toggle="modal"
                    data-target="#filterExpense">
                    <span>
                        Filter Expense Data
                    </span>
                ...
                {{-- farmer modal --}}
                @include('admin.analytics.inc.expense_modal')
            </div>
            <!-- /.card-body -->
        </div>
