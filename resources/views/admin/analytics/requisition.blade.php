    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Requisition Analytics</h1>
                    </div><!-- /.col -->
        ...
        <div class="card">
            ...
            @if ($type == 'Request')
                <div class="card">
                    ...
                    <div class="card-header">
                        Search And Sort Requisition Data
                    </div>
                    {{-- body --}}
                    <div class="card-body">
                        ...
                        <button class="btn btn-warning m-2 text-dark" type="button" data-toggle="modal"
                            data-target="#filterRequisition">
                            <span>
                                Filter Requisition Data
                            </span>
                        ...
                        {{-- staff modal --}}
                        @include('admin.analytics.inc.requisition_modal')
            ...
            @else
                <div class="card">
                    ...
                    {{-- heading --}}
                    <div class="card-header">
                        Search And Sort Per Diems Data
                    </div>
                    {{-- body --}}
                    <div class="card-body">
                        ...
                        {{-- filter PDM --}}
                        <button class="btn btn-warning m-2 text-dark" type="button" data-toggle="modal"
                            data-target="#filterPDM">
                            <span>
                                Filter Per Diems Data
                            </span>
                            <span class="ml-2 text-white">
                                <i class="fas fa-bars"></i>
                            </span>
                        ...
                        {{-- staff modal --}}
                        @include('admin.analytics.inc.pdm_modal')
