...
@section('page')
    ...
    <div class="content-wrapper">
        ...
        {{-- action bar --}}
        <a class="btn btn-secondary m-2 text-white" href="{{ url('proof/uploadrequest') }}">
            <span>
                Upload Requisition Payment Proof
            </span>
        ...
        {{-- action bar --}}
        <a class="btn btn-secondary m-2 text-white" href="{{ url('proof/uploadpdm') }}">
            <span>
                Upload Per Diem Payment Proof
            </span>
            <span class="ml-2 text-white">
                <i class="fas fa-plus"></i>
            </span>
